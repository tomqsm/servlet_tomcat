...
public class DecoratorFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest req, ServletResponse response)
        ...
        try {
            req.setAttribute("xml", NodeModel.parse(new File(req.getServletContext().getRealPath("WEB-INF/freemarker/application.xml"))));
            req.setAttribute("scripts", NodeModel.parse(new File(req.getServletContext().getRealPath(req.getServletContext().getInitParameter("scripts")))));
            req.setAttribute("csses", NodeModel.parse(new File(req.getServletContext().getRealPath(req.getServletContext().getInitParameter("csses")))));
